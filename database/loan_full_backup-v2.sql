...
--
-- Table structure for table `about_content_tbls`
--

CREATE TABLE `about_content_tbls` (
...
--
-- Table structure for table `disclaimer_content_tbls`
--

CREATE TABLE `disclaimer_content_tbls` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `content` varchar(255) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
--
-- Table structure for table `lon_edit_requests`
--

CREATE TABLE `lon_edit_requests` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `loan_id` int(11) NOT NULL,
  `edit_by` varchar(255) NOT NULL,
  `seenstatus` varchar(255) NOT NULL DEFAULT 'unseen',
  ...
  `loanInstallment` int(22) DEFAULT NULL,
  `TotalIntrestAmountForEveryInstallment` double(11,2) DEFAULT NULL,
...
CREATE TABLE `notifications` (
  ...
  `n_for` varchar(255) DEFAULT NULL,
  `n_type` varchar(255) NOT NULL,
  `n_type_id` varchar(255) NOT NULL,
  `n_status` varchar(255) NOT NULL DEFAULT 'unseen' COMMENT '1=seen,2=unseen',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `notifications` (`id`, `user_id`, `n_for`, `n_type`, `n_type_id`, `n_status`, `created_at`, `updated_at`) VALUES
(1, 4, 'manager', 'New form', '1', 'seen', NULL, NULL),
(2, 4, 'manager', 'New form', '2', 'seen', NULL, NULL),
(3, 3, 'superAdmin', 'Approve Form', '1', 'seen', NULL, NULL),
(4, 3, 'noticeAdmin', 'Approve Form', '1', 'seen', NULL, NULL),
(5, 3, 'loanOfficer', 'Approve Form', '1', 'seen', NULL, NULL),
(6, 3, 'superAdmin', 'Rejected Form', '2', 'seen', NULL, NULL),
(7, 3, 'noticeAdmin', 'Rejected Form', '2', 'seen', NULL, NULL),
(8, 3, 'loanOfficer', 'Rejected Form', '2', 'seen', NULL, NULL),
(9, 1, 'loanOfficer', 'Approve Form', '1', 'seen', NULL, NULL),
(10, 1, 'manager', 'Approve Form', '1', 'seen', NULL, NULL),
(11, 1, 'manager', 'Aproved Edit Request', '1', 'seen', NULL, NULL),
(12, 4, 'manager', 'New form', '3', 'seen', NULL, NULL),
(13, 3, 'superAdmin', 'Approve Form', '3', 'seen', NULL, NULL),
(14, 3, 'noticeAdmin', 'Approve Form', '3', 'seen', NULL, NULL),
(15, 3, 'loanOfficer', 'Approve Form', '3', 'seen', NULL, NULL),
(16, 1, 'loanOfficer', 'Approve Form', '3', 'seen', NULL, NULL),
(17, 1, 'manager', 'Approve Form', '3', 'seen', NULL, NULL),
(18, 4, 'manager', 'New form', '4', 'seen', NULL, NULL),
(19, 4, 'manager', 'New form', '5', 'seen', NULL, NULL),
(20, 3, 'superAdmin', 'Rejected Form', '4', 'seen', NULL, NULL),
(21, 3, 'noticeAdmin', 'Rejected Form', '4', 'seen', NULL, NULL),
(22, 3, 'loanOfficer', 'Rejected Form', '4', 'seen', NULL, NULL),
(23, 4, 'manager', 'New form', '6', 'seen', NULL, NULL),
(24, 4, 'manager', 'New form', '7', 'seen', NULL, NULL),
(25, 3, 'superAdmin', 'Rejected Form', '5', 'seen', NULL, NULL),
(26, 3, 'noticeAdmin', 'Rejected Form', '5', 'seen', NULL, NULL),
(27, 3, 'loanOfficer', 'Rejected Form', '5', 'seen', NULL, NULL),
(28, 3, 'superAdmin', 'Approve Form', '6', 'seen', NULL, NULL),
(29, 3, 'noticeAdmin', 'Approve Form', '6', 'seen', NULL, NULL),
(30, 3, 'loanOfficer', 'Approve Form', '6', 'seen', NULL, NULL),
(31, 3, 'superAdmin', 'Approve Form', '7', 'seen', NULL, NULL),
(32, 3, 'noticeAdmin', 'Approve Form', '7', 'seen', NULL, NULL),
(33, 3, 'loanOfficer', 'Approve Form', '7', 'seen', NULL, NULL),
(34, 1, 'loanOfficer', 'Approve Form', '6', 'seen', NULL, NULL),
(35, 1, 'manager', 'Approve Form', '6', 'seen', NULL, NULL),
(36, 1, 'loanOfficer', 'Approve Form', '7', 'seen', NULL, NULL),
(37, 1, 'manager', 'Approve Form', '7', 'seen', NULL, NULL),
(38, 4, 'manager', 'New form', '8', 'seen', NULL, NULL),
(39, 4, 'manager', 'New form', '9', 'seen', NULL, NULL),
(40, 4, 'manager', 'New form', '10', 'seen', NULL, NULL),
(41, 4, 'manager', 'New form', '11', 'seen', NULL, NULL),
(42, 4, 'manager', 'New form', '12', 'seen', NULL, NULL),
(43, 3, 'superAdmin', 'Approve Form', '12', 'seen', NULL, NULL),
(44, 3, 'noticeAdmin', 'Approve Form', '12', 'seen', NULL, NULL),
(45, 3, 'loanOfficer', 'Approve Form', '12', 'seen', NULL, NULL),
(46, 3, 'superAdmin', 'Approve Form', '8', 'seen', NULL, NULL),
(47, 3, 'noticeAdmin', 'Approve Form', '8', 'seen', NULL, NULL),
(48, 3, 'loanOfficer', 'Approve Form', '8', 'seen', NULL, NULL),
(49, 1, 'loanOfficer', 'Rejected Form', '8', 'seen', NULL, NULL),
(50, 1, 'manager', 'Rejected Form', '8', 'seen', NULL, NULL),
(51, 4, 'manager', 'New form', '13', 'seen', NULL, NULL),
(52, 3, 'superAdmin', 'Approve Form', '13', 'seen', NULL, NULL),
(53, 3, 'noticeAdmin', 'Approve Form', '13', 'seen', NULL, NULL),
(54, 3, 'loanOfficer', 'Approve Form', '13', 'seen', NULL, NULL),
(55, 1, 'loanOfficer', 'Approve Form', '13', 'seen', NULL, NULL),
(56, 1, 'manager', 'Approve Form', '13', 'seen', NULL, NULL),
(57, 3, 'superAdmin', 'Approve Form', '10', 'seen', NULL, NULL),
(58, 3, 'noticeAdmin', 'Approve Form', '10', 'seen', NULL, NULL),
(59, 3, 'loanOfficer', 'Approve Form', '10', 'seen', NULL, NULL),
(60, 1, 'loanOfficer', 'Approve Form', '10', 'seen', NULL, NULL),
(61, 1, 'manager', 'Approve Form', '10', 'seen', NULL, NULL),
(62, 4, 'manager', 'New form', '14', 'seen', NULL, NULL),
(63, 4, 'manager', 'New form', '15', 'seen', NULL, NULL),
(64, 3, 'superAdmin', 'Approve Form', '15', 'seen', NULL, NULL),
(65, 3, 'noticeAdmin', 'Approve Form', '15', 'unseen', NULL, NULL),
(66, 3, 'loanOfficer', 'Approve Form', '15', 'seen', NULL, NULL),
(67, 1, 'manager', 'Aproved Edit Request', '1', 'unseen', NULL, NULL),
(68, 3, 'superAdmin', 'Approve Form', '14', 'seen', NULL, NULL),
(69, 3, 'noticeAdmin', 'Approve Form', '14', 'unseen', NULL, NULL),
(70, 3, 'loanOfficer', 'Approve Form', '14', 'seen', NULL, NULL),
(71, 1, 'loanOfficer', 'Approve Form', '14', 'seen', NULL, NULL),
(72, 1, 'manager', 'Approve Form', '14', 'unseen', NULL, NULL),
(73, 1, 'loanOfficer', 'Approve Form', '14', 'seen', NULL, NULL),
(74, 1, 'manager', 'Approve Form', '14', 'unseen', NULL, NULL),
(75, 4, 'manager', 'New form', '16', 'unseen', NULL, NULL),
(76, 1, 'manager', 'Aproved Edit Request', '1', 'unseen', NULL, NULL),
(77, 1, 'manager', 'Aproved Edit Request', '1', 'unseen', NULL, NULL),
(78, 1, 'manager', 'Aproved Edit Request', '1', 'unseen', NULL, NULL),
(79, 1, 'manager', 'Aproved Edit Request', '1', 'unseen', NULL, NULL),
(80, 1, 'manager', 'Aproved Edit Request', '1', 'unseen', NULL, NULL),
(81, 1, 'manager', 'Aproved Edit Request', '1', 'unseen', NULL, NULL),
(82, 1, 'manager', 'Aproved Edit Request', '1', 'unseen', NULL, NULL),
(83, 1, 'manager', 'Aproved Edit Request', '1', 'unseen', NULL, NULL),
(84, 1, 'manager', 'Aproved Edit Request', '1', 'unseen', NULL, NULL),
(85, 1, 'manager', 'Aproved Edit Request', '1', 'unseen', NULL, NULL),
(86, 4, 'manager', 'New form', '17', 'unseen', NULL, NULL),
(87, 2, 'superAdmin', 'Approve Form', '15', 'unseen', NULL, NULL),
(88, 2, 'noticeAdmin', 'Approve Form', '15', 'unseen', NULL, NULL),
(89, 2, 'loanOfficer', 'Approve Form', '15', 'unseen', NULL, NULL),
(90, 1, 'loanOfficer', 'Approve Form', '15', 'unseen', NULL, NULL),
(91, 1, 'manager', 'Approve Form', '15', 'unseen', NULL, NULL),
(92, 1, 'loanOfficer', 'Approve Form', '3', 'unseen', NULL, NULL),
(93, 1, 'manager', 'Approve Form', '3', 'unseen', NULL, NULL),
(94, 1, 'loanOfficer', 'Rejected Form', '6', 'unseen', NULL, NULL),
(95, 1, 'manager', 'Rejected Form', '6', 'unseen', NULL, NULL),
(96, 1, 'loanOfficer', 'Rejected Form', '6', 'unseen', NULL, NULL),
(97, 1, 'manager', 'Rejected Form', '6', 'unseen', NULL, NULL),
(98, 1, 'loanOfficer', 'Rejected Form', '13', 'unseen', NULL, NULL),
(99, 1, 'manager', 'Rejected Form', '13', 'unseen', NULL, NULL),
(100, 3, 'superAdmin', 'Rejected Form', '11', 'unseen', NULL, NULL),
(101, 3, 'noticeAdmin', 'Rejected Form', '11', 'unseen', NULL, NULL),
(102, 3, 'loanOfficer', 'Rejected Form', '11', 'unseen', NULL, NULL),
(103, 3, 'superAdmin', 'Approve Form', '9', 'unseen', NULL, NULL),
(104, 3, 'noticeAdmin', 'Approve Form', '9', 'unseen', NULL, NULL),
(105, 3, 'loanOfficer', 'Approve Form', '9', 'unseen', NULL, NULL),
(106, 4, 'manager', 'New form', '18', 'unseen', NULL, NULL),
(107, 2, 'superAdmin', 'Approve Form', '9', 'unseen', NULL, NULL),
(108, 2, 'noticeAdmin', 'Approve Form', '9', 'unseen', NULL, NULL),
(109, 2, 'loanOfficer', 'Approve Form', '9', 'unseen', NULL, NULL),
(110, 2, 'loanOfficer', 'Rejected Form', '12', 'unseen', NULL, NULL),
(111, 2, 'manager', 'Rejected Form', '12', 'unseen', NULL, NULL),
(112, 4, 'manager', 'New form', '19', 'unseen', NULL, NULL),
(113, 3, 'superAdmin', 'Rejected Form', '11', 'unseen', NULL, NULL),
(114, 3, 'noticeAdmin', 'Rejected Form', '11', 'unseen', NULL, NULL),
(115, 3, 'loanOfficer', 'Rejected Form', '11', 'unseen', NULL, NULL),
(116, 3, 'superAdmin', 'Approve Form', '19', 'unseen', NULL, NULL),
(117, 3, 'noticeAdmin', 'Approve Form', '19', 'unseen', NULL, NULL),
(118, 3, 'loanOfficer', 'Approve Form', '19', 'unseen', NULL, NULL),
(119, 2, 'loanOfficer', 'Rejected Form', '1', 'unseen', NULL, NULL),
(120, 2, 'manager', 'Rejected Form', '1', 'unseen', NULL, NULL),
(121, 2, 'superAdmin', 'Approve Form', '19', 'unseen', NULL, NULL),
(122, 2, 'noticeAdmin', 'Approve Form', '19', 'unseen', NULL, NULL),
(123, 2, 'loanOfficer', 'Approve Form', '19', 'unseen', NULL, NULL),
(124, 1, 'loanOfficer', 'Rejected Form', '9', 'unseen', NULL, NULL),
(125, 1, 'manager', 'Rejected Form', '9', 'unseen', NULL, NULL),
(126, 1, 'loanOfficer', 'Approve Form', '19', 'unseen', NULL, NULL),
(127, 1, 'manager', 'Approve Form', '19', 'unseen', NULL, NULL);
...
(1, NULL, 'Loan Officer N', 'Dhaka', 4, 'amdadulhaquemelon15442@gmail.com', '01617253586', 'Narsingdi, Dhaka, Bangladesh', NULL, NULL, NULL);
...
--
-- Table structure for table `privacy_content_tbls`
--

CREATE TABLE `privacy_content_tbls` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `content` varchar(255) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
(1, 1, NULL, '2023-01-08 20:40:38', '127.0.0.1', '50-C2-E8-0B-4A-63', NULL, 'WebKit', 'Chrome', 'Windows', '', '2023-01-08 20:40:38', '2023-01-02 19:16:55', '2023-01-08 20:40:38'),
(2, 4, NULL, '2023-01-08 20:24:02', '127.0.0.1', '50-C2-E8-0B-4A-63', NULL, 'WebKit', 'Chrome', 'Windows', '', '2023-01-08 20:24:03', '2023-01-02 19:24:06', '2023-01-08 20:24:03'),
(3, 3, NULL, '2023-01-08 20:32:29', '127.0.0.1', '50-C2-E8-0B-4A-63', NULL, 'WebKit', 'Chrome', 'Windows', '', '2023-01-08 20:32:30', '2023-01-02 19:51:28', '2023-01-08 20:32:30'),
(4, 2, NULL, '2023-01-08 20:38:38', '127.0.0.1', '50-C2-E8-0B-4A-63', NULL, 'WebKit', 'Chrome', 'Windows', '', '2023-01-08 20:38:38', '2023-01-02 20:22:48', '2023-01-08 20:38:38');
...
--
-- Indexes for table `about_content_tbls`
--
ALTER TABLE `about_content_tbls`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `disclaimer_content_tbls`
--
ALTER TABLE `disclaimer_content_tbls`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `lon_edit_requests`
--
ALTER TABLE `lon_edit_requests`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `privacy_content_tbls`
--
ALTER TABLE `privacy_content_tbls`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `about_content_tbls`
--
ALTER TABLE `about_content_tbls`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `disclaimer_content_tbls`
--
ALTER TABLE `disclaimer_content_tbls`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `lon_edit_requests`
--
ALTER TABLE `lon_edit_requests`
...
--
-- AUTO_INCREMENT for table `privacy_content_tbls`
--
ALTER TABLE `privacy_content_tbls`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
