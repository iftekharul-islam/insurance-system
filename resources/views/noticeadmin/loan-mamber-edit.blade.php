        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="tile" style="    border-top: 4px solid #009688;border-radius: 10px 10px 0px 0px;">
                    ...
                    <!---Error Message--->
                    <div class="tile-body">
                        <form action="{{ route('noticeadmin.member.edit.post', $data->id) }}" class="row" method="POST"
                            ...
                            {{-- <div class="form-group col-md-4">
                                ...
                                <input id="LoanInstallmentAmount" required="" type="number" disabled class="form-control" name="loanInstallmentamount"
                                    placeholder="Enter Installment Amount" value="{{ $data->TotalIntrestAmountForEveryInstallment }}">
                            </div> --}}
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input  type="file" class="form-control" name="granter_id_photo"
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="file" class="form-control" name="granter2_id_photo"
