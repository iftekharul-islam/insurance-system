...
<body>
    ...
    font-weight: 600;">&copy;Copyright 2022. Design & Developed
                                By <a target="_blank" href="https://www.facebook.com/suzaul.sumon">Milky Way It
                                    Solution</a></p>
                ...
                <div class="col-sm-8 px-0 img d-none d-sm-block">
                    ...
                    <div id="guide">
                        <h4 style="margin-left:150px;" class="text-white"><i class="fa-solid fa-play security"
                                style="border: 1px solid; padding:2px;font-size:12px;"></i>&nbsp;Security Guidelines
                        </h4>
                        <div id="instruc">
                        ...
                        <div id="help" style="margin-top:6px;">
                            <h4><i class="fa-solid fa-play security"
                                    style="border: 1px solid; padding:2px;font-size:12px;"></i>&nbsp;Need Help?</h4>
                            <div class="row" style="margin-left:0px !important;margin-right:0px !important;">
                                <div class="col-lg-3">
                                    <div class="sup">
                                        <h5 style="margin-top: 4px;margin-left: 14px;">
                                            <i style="color:#e4e912;" class="fa-solid fa-phone"></i>&nbsp;
                                            Help line 09638654171
                                        </h5>
                                    </div>
                                </div>

                                <div class="col-lg-5" style="margin-left: -24px;">
                                    <div class="sup">
                                        <h5 style="margin-top: 4px;margin-left: 14px;">
