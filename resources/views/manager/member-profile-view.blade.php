                ...
                <div class="tile">
                    <div class="tile-body">
                        ...
                        <td>
                            ...
                            @if ($data->status == '0')
                                <a href="{{ route('manager.loan.approve', $data->id) }}"
                            ...
                            @elseif($data->status == '1'|| $data->status == '2'|| $data->status == '3')
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('manager.loafprofile.rejected', $data->id) }}" method="POST">
                            @csrf
