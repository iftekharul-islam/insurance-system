...
<body class="paper_body">
    ...
    <div class="html-content paper_content">
            ...
            <div class="col-6">
                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        <p>
                            <span>
                                @if (!empty($loanofficer_profile_info))
                                {{ $loanofficer_profile_info->manager_branch }}
                                @endif
                            </span>
                        </p>
                    </div>
                    ...
                    <div class="col-8">
                        <p>
                            <span>
                                ...
                                {{ $loanofficer_profile_info->address }}
                                @endif
                            </span>
                        </p>
                    </div>
        ...
        <div class="row data_deader">
            <div class="col-6 text-left header_data_box">
                <span>Trans Date</span>
            </div>

            <div class="col-6 text-center header_data_box">
                <span>Loan Amount</span>
            </div>

            <div class="col-6 text-center header_data_box">
                <span>Total Recived Amount</span>
            </div>

        </div>

        <div class="row data_row">
            <div class="col-6 data_row_box">
                <span>
                    @if (!empty($first_loan_aproved_date_under_loanofficer->created_at))

                    {{ \Carbon\Carbon::parse($first_loan_aproved_date_under_loanofficer->created_at)->format('d/m/Y') }}
                    @endif
                </span>
                &nbsp;to&nbsp;
            ...
            <div class="col-6 text-center data_row_box">
                <span>৳&nbsp;{{ $total_loan_under_loanofficer }}</span>
            </div>

            <div class="col-6 text-center data_row_box">
                <span>৳&nbsp;{{ $total_loan_recived_under_loanofficer }}</span>
            </div>
        </div>
        <!-- Tran H. -->
