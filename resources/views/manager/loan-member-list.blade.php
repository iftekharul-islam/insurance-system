                            ...
                            <div class="col-md-6">
                                <div class="form-group" style="line-height: 34px;margin-top: 10px;">
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                           <form action="{{ route('manager.member.list.bystatus') }}" method="POST" id="statusType">
                                            @csrf
                            ...
                            <tbody>
                                @foreach ($data as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('manager.loan.profile-view', $data->id) }}"
                                        ...
                                        <td>
                                            @if($data->status == "0" && !$data->re_submit_status == '1')
                                                <a href="{{ route('manager.loanprofile.edit', $data->id) }}"
