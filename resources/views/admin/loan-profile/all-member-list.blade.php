                            ...
                            <div class="col-md-6">
                                <div class="form-group" style="line-height: 34px;margin-top: 10px;">
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                           <form action="{{ route('all.member.list.bystatus') }}" method="POST" id="statusType">
                                            @csrf
                            ...
                            <tbody>
                                @foreach ($data as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('member.view.profile.byadmin', base64_encode($data->id)) }}"
                                        ...
                                        <td>
                                            <a href="{{ route('member.edit.byadmin', base64_encode($data->id)) }}"
