    ...
    <div class="html-content paper_content">
            ...
            <div class="col-6">
                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        <p>
                            <span>
                                @if (!empty($manager_profile_info))
                                {{ $manager_profile_info->manager_branch }}
                                @endif
                            </span>
                        </p>
                    </div>
        ...
        <div class="row data_row">
            <div class="col-6 data_row_box">
                <span>{{ \Carbon\Carbon::parse($first_loan_aproved_date_under_manager->created_at)->format('d/m/Y') }}</span>
                &nbsp;to&nbsp;
                <span>{{ \Carbon\Carbon::today()->format('d/m/Y') }}</span>
            </div>

            <div class="col-6 text-center data_row_box">
                <span>৳&nbsp;{{ $total_loan_under_manager }}</span>
            </div>

            <div class="col-6 text-center data_row_box">
                <span>৳&nbsp;{{ $total_loan_recived_under_manager }}</span>
            </div>
        </div>
        <!-- Tran H. -->
