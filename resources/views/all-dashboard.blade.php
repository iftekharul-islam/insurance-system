                ...
                @foreach ($data as $data)
                    <blockquote class="blockquote mb-3">
                        <footer class="blockquote-footer">
                            ...
                            @if ($data->noticestatus != "general")
                                <cite title="Source Title" style="background: red;color: #fff;padding: 0px 6px;border-radius: 6px;">
                                    {{ $data->noticestatus }}
                                </cite>
                            @endif
                        </footer>
                        ...
                        <footer class="blockquote-footer">
                            <cite title="Source Title" class="text-info">
                                File Name: <span class="text-black">notic-file.pdf</span>
                            </cite>
