...
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="tile" style="border-top: 4px solid #009688;border-radius: 10px 10px 0px 0px;">
                    ...
                    <!---Error Message--->
                    <div class="tile-body">
                        <form class="row" method="post" enctype="multipart/form-data" action="{{ route('user.form') }}">
                            @csrf

                            <div class="form-group col-md-3">
                                <label class="control-label" style="font-weight:bold;">Name of loan customer ( In English
                                    ):&nbsp;<sup style="color:red">*</sup> </label>
                                <input required="" id="my-field10" type="text" class="form-control" name="name"
                                    placeholder="Name of loan customer">
                            </div>

                            <div class="form-group col-md-3">
                                <label class="control-label" style="font-weight:bold;"> Phone Numbers : ( In English
                                    ):&nbsp;<sup style="color:red">*</sup> </label>
                                <input required="" type="number" maxlength="3"   class="form-control" name="mobile"
                            ...
                            <div class="form-group col-md-2">
                                <img src="https://www.pngitem.com/pimgs/m/150-1503945_transparent-user-png-default-user-image-png-png.png"
                                    id="img-src" style="border: 1px solid black; height: 103px; max-width: 100%;">
                            </div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input required="" id="my-field5" type="text" class="form-control" name="fathers_name"
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input required="" type="text" id="my-field7" class="form-control" name="mothers_name"
                            ...
                            <div class="form-group col-md-2">
                                <img src="https://www.pngitem.com/pimgs/m/150-1503945_transparent-user-png-default-user-image-png-png.png"
                                    id="id-card-img" style="border: 1px solid black; height: 103px; max-width: 100%;">
                            </div>
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <input id="LoanAmmount" required="" type="number" class="form-control" name="loan_amount"
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input id="InstallmentFun" required="" type="number" class="form-control" name="loanInstallment"
                                    placeholder="Enter loan Installment">
                            </div>
                            ...
                            {{-- <div class="form-group col-md-4">
                                ...
                                <input id="LoanInstallmentAmount" required="" type="number" disabled class="form-control" name="loanInstallmentamount"
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input required="" id="my-field9" type="text" class="form-control" name="granter_name"
                            ...
                            <div class="form-group col-md-2">
                                <img src="https://www.pngitem.com/pimgs/m/150-1503945_transparent-user-png-default-user-image-png-png.png"
                                    id="img-granter" style="border: 1px solid black; height: 103px; max-width: 100%;">
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input required="" type="file" class="form-control" name="granter_id_photo"
                                    onchange="ranterIDphoto(this);">
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input required="" id="my-field6" type="text" class="form-control" name="granter_fathers_name"
                                    placeholder="Father's name">
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input required="" type="text" id="my-field8" class="form-control" name="granter_mothers_name"
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input required="" id="my-field3" type="text" class="form-control" name="granter_2_name"
                                    placeholder="Granter Name">
                            </div>
                            ...
                            <div class="form-group col-md-2">
                                <img src="https://www.pngitem.com/pimgs/m/150-1503945_transparent-user-png-default-user-image-png-png.png"
                                    id="img2-granter" style="border: 1px solid black;height: 103px; max-width: 100%;">
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input required="" type="file" class="form-control" name="granter2_id_photo"
                                    onchange="ranter2IDphoto(this);">
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input required="" id="my-field4" type="text" class="form-control" name="granter_2_fathers_name"
                                    placeholder="Father's name">
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="my-field9" name="granter_2_mothers_name"
                                    placeholder="Mother's name" required="">
                            </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('#InstallmentFun').on('keyup',function(){
                var intrestRate = $("#intrestRate").val();
                var LoanAmmount = $("#LoanAmmount").val();
                var InstallmentFun = $("#InstallmentFun").val();

                // var persent = LoanAmmount*intrestRate/100;

                // console.log(persent);

                var answer = LoanAmmount / InstallmentFun;
                // console.log(num1+num2);

                $("#LoanInstallmentAmount").val(answer.toFixed(2));
            });
            ...
            $('#my-field3').bind('keypress', testInput);
            $('#my-field4').bind('keypress', testInput);
            $('#my-field5').bind('keypress', testInput);
            $('#my-field6').bind('keypress', testInput);
            $('#my-field7').bind('keypress', testInput);
            $('#my-field8').bind('keypress', testInput);
            $('#my-field9').bind('keypress', testInput);
            $('#my-field10').bind('keypress', testInput);
            $('#my-field11').bind('keypress', testInput);
            $('#my-field12').bind('keypress', testInput);
